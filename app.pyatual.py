# Célula de Código Completo: app.py
%%writefile app.py
import streamlit as st
import pandas as pd
import plotly.express as px

# --- FUNÇÃO DE CARREGAMENTO E LIMPEZA DE DADOS (INCLUINDO CÁLCULO DE PROGRESSO) ---
@st.cache_data
def load_data():
    # Carrega os DataFrames. Estes arquivos devem estar na mesma pasta do app.py
    ...
    # --- CÁLCULO DO PROGRESSO (ANÁLISE ODS 7: VALOR FINAL - VALOR INICIAL) ---
    df_min_max_ano = df_ods7.groupby('Pais')['Ano'].agg(
        Ano_Min='min', 
        Ano_Max='max'
    ).reset_index()

    # Merge para Valor Inicial e Final e cálculo do progresso
    ...
    # Calcula e ordena o Progresso para o TOP 3
...
if not df_filtrado.empty:
    ...
    # --- TOP 3 PROGRESSO (NOVA SEÇÃO: VISÍVEL APENAS PARA ODS 7) ---
    if ods_escolhido == 'ODS 7: Energia Limpa':
        ...
        # Preenche as métricas com dados do DataFrame pré-calculado
        with col1:
    ...
    # --- GRÁFICO DE BARRAS (RANKING POR ÚLTIMO ANO) ---
